...
import { InternalListener, Operator, Stream } from "../mod.ts";
...
export interface SampleCombineSignature {
  ...
  <T1, T2>(
    s1: Stream<T1>,
    s2: Stream<T2>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2]>;
  <T1, T2, T3>(
    s1: Stream<T1>,
    s2: Stream<T2>,
    s3: Stream<T3>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3]>;
  <T1, T2, T3, T4>(
    s1: Stream<T1>,
    s2: Stream<T2>,
    s3: Stream<T3>,
    s4: Stream<T4>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3, T4]>;
  <T1, T2, T3, T4, T5>(
    s1: Stream<T1>,
    s2: Stream<T2>,
    s3: Stream<T3>,
    s4: Stream<T4>,
    s5: Stream<T5>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3, T4, T5]>;
  <T1, T2, T3, T4, T5, T6>(
    s1: Stream<T1>,
    s2: Stream<T2>,
    s3: Stream<T3>,
    ...
    s5: Stream<T5>,
    s6: Stream<T6>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3, T4, T5, T6]>;
  <T1, T2, T3, T4, T5, T6, T7>(
    ...
    s6: Stream<T6>,
    s7: Stream<T7>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3, T4, T5, T6, T7]>;
  <T1, T2, T3, T4, T5, T6, T7, T8>(
    ...
    s7: Stream<T7>,
    s8: Stream<T8>,
  ): <T>(s: Stream<T>) => Stream<[T, T1, T2, T3, T4, T5, T6, T7, T8]>;
...
sampleCombine = function sampleCombine(...streams: Array<Stream<any>>) {
  return function sampleCombineOperator(
    sampler: Stream<any>,
  ): Stream<Array<any>> {
